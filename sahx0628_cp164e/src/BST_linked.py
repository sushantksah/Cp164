...
class BST:
    ...
    def flip(self):
        ...
        ---------------------------------------------------------
        """
        return self._flip_aux(self._root)
    ...
    def _are_flipped_aux(self, node1, node2):
        ...
        if node1 is None and node2 is None:
            ...
            finished = (self._are_finished_aux(node1._left, node2._right)
                        and self._are_finished_aux(node1._right, node2._left))
