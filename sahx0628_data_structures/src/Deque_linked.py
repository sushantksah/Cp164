...
class Deque:
    ...
    def insert_front(self, value):
        ...
        """
        # your code here
        pass1 = _Deque_Node(deepcopy(value), None, self._front)

        if self._front is None:
            self._rear = pass1

        else:
            self._front._prev = pass1
    ...
    def insert_rear(self, value):
        ...
        """
        # your code here
        pass2 = _Deque_Node(value, self._rear, None)
