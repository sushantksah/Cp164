...
class List:
    ...
    def clean(self):
        ...
        seen = [x for x in self._values if not (x in done or done.add(x))]
        self._values = seen
    ...
    def insert(self, i, value):
        ...
        if -len(self._values) <= i <= len(self._values) - 1:
            self._values.insert(i, copy)

        elif i < -len(self._values):
            self._values.insert(0, copy)
    ...
    def max(self):
        ...
        # Your code here
        maxVal = self._values[0]

        for value in self._values[1:]:
            if value > maxVal:
                maxVal = value

        maxValue = deepcopy(maxVal)
    ...
    def min(self):
        ...
        # Your code here
        minVal = self._values[0]

        for value in self._values[1:]:
            if value < minVal:
                minVal = value

        minValue = deepcopy(minVal)
