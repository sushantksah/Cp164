...
class Sorted_List:
    ...
    def clean(self):
        ...
        while y < len(self._values) - 1:
            if self._values[y] == self._values[y + 1]:
                self._values[y+1].pop()
            else:
                y += 1
