...
class BST:
    ...
    def flip(self):
        ...
        ---------------------------------------------------------
        """
        self._flip_aux(your_values)
        return

    def _flip_aux(self, your_parameters):
        """
        ---------------------------------------------------------
    ...
    def are_flipped(self, target):
        ...
        -------------------------------------------------------
        """
        return self._are_flipped_aux(your_values)

    def _are_flipped_aux(self, your_parameters):
        """
        -------------------------------------------------------
    ...
    def total_height(self):
        ...
        ---------------------------------------------------------
        """
        return self._total_height_aux(your_values)

    def _total_height_aux(self, your_parameters):
        """
        ---------------------------------------------------------
        Returns the total heights of a bst.
        ---------------------------------------------------------
